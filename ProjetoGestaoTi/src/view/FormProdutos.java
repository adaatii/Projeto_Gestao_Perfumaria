...
public class FormProdutos extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        for (Produtos cont : lista) {
            dado.addRow(new Object[]{cont.getId(), cont.getDescricao(), cont.getPreco(), cont.getQtd_estoque(),
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditarActionPerformed
        ...
        op = JOptionPane.showOptionDialog(null, "Deseja realmente editar?", "Informação", JOptionPane.DEFAULT_OPTION,
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int op;
        Object[] options = {"Cancelar", "Confirmar"};
        op = JOptionPane.showOptionDialog(null, "Deseja realmente excluir?", "Informação", JOptionPane.DEFAULT_OPTION,
                JOptionPane.WARNING_MESSAGE, null, options, options[1]);
        if (op == 1) {
            Produtos obj = new Produtos();
